---
name: cell-playground/base-system-rules
description: Global guardrails applied as the base system rules for every Studio generation call.
usage: Composed into the system prompt envelope by buildSystemPrompt in phase-prompts.ts.
version: 1.0.0
arguments:
  - name: zod_output_schema
    description: JSON schema string derived from the active phase's Zod contract.
    type: string
    source: system
    required: true
---
