...
This package is a thin wrapper around [`@ikary-manifest/cli`](https://www.npmjs.com/package/@ikary-manifest/cli). It exists so you can run `npx ikary` instead of `npx @ikary-manifest/cli`.
