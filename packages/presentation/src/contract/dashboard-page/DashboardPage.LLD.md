...
- Own canonical fields such as `kind`, `state`, `key`, `label`, `icon`, `href`.
...
- Presentation input: `DashboardPagePresentation` validated by the runtime validator in this folder.
...
- Primary schema fields consumed at runtime include `kind`, `state`, `key`, `label`, `icon`, `href`, `actionKey`, `disabled`.
...
- Direct primitive dependencies in component composition: `..`, `ActivityFeed`, `EmptyState`, `MetricCard`, `PageHeader`.
...
- Contract schema: `libs/cell-contract-presentation/src/contract/dashboard-page/DashboardPagePresentationSchema.ts`.
- Contract validator: `libs/cell-contract-presentation/src/contract/dashboard-page/validate-runtime-dashboard-page-presentation.ts`.
- LLD doc: `libs/cell-contract-presentation/src/contract/dashboard-page/DashboardPage.LLD.md`.
- Runtime: `libs/cell-runtime-ui/src/primitives/dashboard-page/DashboardPage.adapter.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/dashboard-page/DashboardPage.resolver.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/dashboard-page/DashboardPage.tsx`.
- Runtime: `libs/cell-runtime-ui/src/primitives/dashboard-page/DashboardPage.types.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/dashboard-page/index.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/dashboard-page/registerDashboardPage.ts`.
