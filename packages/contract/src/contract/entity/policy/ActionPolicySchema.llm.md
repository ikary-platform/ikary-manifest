...
- Schema source: `libs/cell-contract-core/src/contract/entity/policy/ActionPolicySchema.ts`.
- Human contract doc: `ActionPolicySchema.md`.
- LLM contract doc: `ActionPolicySchema.llm.md`.
- Samples file: `ActionPolicySchema.samples.json` (minimum 5 valid examples).
