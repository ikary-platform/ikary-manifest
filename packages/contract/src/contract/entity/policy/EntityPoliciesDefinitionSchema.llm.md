...
- Schema source: `libs/cell-contract-core/src/contract/entity/policy/EntityPoliciesDefinitionSchema.ts`.
- Human contract doc: `EntityPoliciesDefinitionSchema.md`.
- LLM contract doc: `EntityPoliciesDefinitionSchema.llm.md`.
- Samples file: `EntityPoliciesDefinitionSchema.samples.json` (minimum 5 valid examples).
