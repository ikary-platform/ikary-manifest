...
- Schema source: `libs/cell-contract-core/src/contract/entity/field/FieldRuleTypeSchema.ts`.
- Human contract doc: `FieldRuleTypeSchema.md`.
- LLM contract doc: `FieldRuleTypeSchema.llm.md`.
- Samples file: `FieldRuleTypeSchema.samples.json` (minimum 5 valid examples).
