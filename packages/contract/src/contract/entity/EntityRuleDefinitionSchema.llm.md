# EntityRuleDefinitionSchema LLD
...
- `paths` from the validated contract payload.
...
- Schema source: `libs/cell-contract-core/src/contract/entity/EntityRuleDefinitionSchema.ts`.
- Human contract doc: `EntityRuleDefinitionSchema.md`.
- LLM contract doc: `EntityRuleDefinitionSchema.llm.md`.
- Samples file: `EntityRuleDefinitionSchema.samples.json` (minimum 5 valid examples).
