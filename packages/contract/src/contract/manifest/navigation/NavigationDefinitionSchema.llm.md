...
- Schema source: `libs/cell-contract-core/src/contract/manifest/navigation/NavigationDefinitionSchema.ts`.
- Human contract doc: `NavigationDefinitionSchema.md`.
- LLM contract doc: `NavigationDefinitionSchema.llm.md`.
- Samples file: `NavigationDefinitionSchema.samples.json` (minimum 5 valid examples).
