...
- `path` from the validated contract payload.
...
- Composes nested schemas: `PageMenuSchema`, `PageTypeSchema`.
...
- Schema source: `libs/cell-contract-core/src/contract/manifest/page/PageDefinitionSchema.ts`.
- Human contract doc: `PageDefinitionSchema.md`.
- LLM contract doc: `PageDefinitionSchema.llm.md`.
- Samples file: `PageDefinitionSchema.samples.json` (minimum 5 valid examples).
