...
- Composes nested schemas: `DomainEventActorTypeSchema`.
...
- Schema source: `libs/cell-contract-core/src/contract/manifest/domain-event/DomainEventActorSchema.ts`.
- Human contract doc: `DomainEventActorSchema.md`.
- LLM contract doc: `DomainEventActorSchema.llm.md`.
- Samples file: `DomainEventActorSchema.samples.json` (minimum 5 valid examples).
