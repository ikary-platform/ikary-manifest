...
- A scalar payload validated by the schema.
- Optional runtime context supplied by host orchestration.
...
- Schema source: `libs/cell-contract-core/src/contract/manifest/domain-event/DomainEventActorTypeSchema.ts`.
- Human contract doc: `DomainEventActorTypeSchema.md`.
- LLM contract doc: `DomainEventActorTypeSchema.llm.md`.
- Samples file: `DomainEventActorTypeSchema.samples.json` (minimum 5 valid examples).
