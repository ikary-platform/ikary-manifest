...
- `title` from the validated contract payload.
- `mountPath` from the validated contract payload.
- `landingPage` from the validated contract payload.
...
- Schema source: `libs/cell-contract-core/src/contract/manifest/shell/CellMountDefinitionSchema.ts`.
- Human contract doc: `CellMountDefinitionSchema.md`.
- LLM contract doc: `CellMountDefinitionSchema.llm.md`.
- Samples file: `CellMountDefinitionSchema.samples.json` (minimum 5 valid examples).
