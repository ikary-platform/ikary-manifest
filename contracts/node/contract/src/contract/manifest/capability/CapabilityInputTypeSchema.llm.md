...
- Schema source: `libs/cell-contract-core/src/contract/manifest/capability/CapabilityInputTypeSchema.ts`.
- Human contract doc: `CapabilityInputTypeSchema.md`.
- LLM contract doc: `CapabilityInputTypeSchema.llm.md`.
- Samples file: `CapabilityInputTypeSchema.samples.json` (minimum 5 valid examples).
