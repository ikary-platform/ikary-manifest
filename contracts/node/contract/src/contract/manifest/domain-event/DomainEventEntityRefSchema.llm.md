...
- `id` from the validated contract payload.
...
- Schema source: `libs/cell-contract-core/src/contract/manifest/domain-event/DomainEventEntityRefSchema.ts`.
- Human contract doc: `DomainEventEntityRefSchema.md`.
- LLM contract doc: `DomainEventEntityRefSchema.llm.md`.
- Samples file: `DomainEventEntityRefSchema.samples.json` (minimum 5 valid examples).
