...
- `exclude` from the validated contract payload.
...
- Schema source: `libs/cell-contract-core/src/contract/entity/event/EventDefinitionSchema.ts`.
- Human contract doc: `EventDefinitionSchema.md`.
- LLM contract doc: `EventDefinitionSchema.llm.md`.
- Samples file: `EventDefinitionSchema.samples.json` (minimum 5 valid examples).
