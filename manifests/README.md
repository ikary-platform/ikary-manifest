...
2. The TypeScript runtime (`@ikary/cell-loader`) parses YAML, strips meta-properties, validates via Zod
3. The engine (`@ikary/cell-engine`) compiles validated manifests into runtime-ready structures
