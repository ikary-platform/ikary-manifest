...
export function AreaChart(props: AreaChartViewProps) {
  const { data, xKey, series, title, description, height, showGrid, showLegend, legendPosition, showTooltip, stacked, fillOpacity, curved } = props;
