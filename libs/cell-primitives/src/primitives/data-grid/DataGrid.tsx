                    ...
                    >
                      {column.sortable && onSortChange ? (
                        <button
                          ...
                          className={`inline-flex items-center gap-1 rounded-sm font-semibold uppercase tracking-widest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 ${
                            active
                              ? 'text-primary'
