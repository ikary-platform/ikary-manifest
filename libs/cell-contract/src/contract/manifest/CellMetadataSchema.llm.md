...
- Schema source: `libs/cell-contract-core/src/contract/manifest/CellMetadataSchema.ts`.
- Human contract doc: `CellMetadataSchema.md`.
- LLM contract doc: `CellMetadataSchema.llm.md`.
- Samples file: `CellMetadataSchema.samples.json` (minimum 5 valid examples).
