...
- `field` from the validated contract payload.
...
- Composes nested schemas: `FieldRuleTypeSchema`, `ValidationSeveritySchema`.
...
- Schema source: `libs/cell-contract-core/src/contract/entity/field/FieldRuleDefinitionSchema.ts`.
- Human contract doc: `FieldRuleDefinitionSchema.md`.
- LLM contract doc: `FieldRuleDefinitionSchema.llm.md`.
- Samples file: `FieldRuleDefinitionSchema.samples.json` (minimum 5 valid examples).
