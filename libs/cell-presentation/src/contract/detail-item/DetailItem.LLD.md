...
- Own canonical fields such as `type`, `key`, `label`, `field`, `emptyLabel`, `truncate`.
...
- Presentation input: `DetailItemPresentation` validated by the runtime validator in this folder.
...
- Primary schema fields consumed at runtime include `type`, `key`, `label`, `field`, `emptyLabel`, `truncate`, `tooltip`, `dense`.
...
- Contract schema: `libs/cell-contract-presentation/src/contract/detail-item/DetailItemSchema.ts`.
- Contract validator: `libs/cell-contract-presentation/src/contract/detail-item/validation-runtime-detail-item.ts`.
- LLD doc: `libs/cell-contract-presentation/src/contract/detail-item/DetailItem.LLD.md`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-item/DetailItem.adapter.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-item/DetailItem.register.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-item/DetailItem.tsx`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-item/DetailItem.types.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-item/index.ts`.
