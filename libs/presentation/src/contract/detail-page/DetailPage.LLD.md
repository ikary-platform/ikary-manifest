...
- Own canonical fields such as `key`, `label`, `href`, `disabled`, `kind`, `value`.
...
- Presentation input: `DetailPagePresentation` validated by the runtime validator in this folder.
...
- Primary schema fields consumed at runtime include `key`, `label`, `href`, `disabled`, `kind`, `value`, `icon`, `actionKey`.
...
- Direct primitive dependencies in component composition: `..`, `PageHeader`.
...
- Contract schema: `libs/cell-contract-presentation/src/contract/detail-page/DetailPagePresentationSchema.ts`.
- Contract validator: `libs/cell-contract-presentation/src/contract/detail-page/validate-runtime-detail-page-presentation.ts`.
- LLD doc: `libs/cell-contract-presentation/src/contract/detail-page/DetailPage.LLD.md`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-page/DetailPage.adapter.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-page/DetailPage.resolver.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-page/DetailPage.tsx`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-page/DetailPage.types.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-page/index.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/detail-page/registerDetailPage.ts`.
