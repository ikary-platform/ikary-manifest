...
- Presentation input: `MetricCardPresentation` validated by the runtime validator in this folder.
...
- Primary schema fields consumed at runtime include `label`, `href`, `actionKey`, `code`, `path`, `message`, `kind`, `state`.
...
- Contract schema: `libs/cell-contract-presentation/src/contract/metric-card/MetricCardPresentationSchema.ts`.
- Contract validator: `libs/cell-contract-presentation/src/contract/metric-card/validate-runtime-metric-card-presentation.ts`.
- LLD doc: `libs/cell-contract-presentation/src/contract/metric-card/MetricCard.LLD.md`.
- Runtime: `libs/cell-runtime-ui/src/primitives/metric-card/MetricCard.adapter.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/metric-card/MetricCard.resolver.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/metric-card/MetricCard.tsx`.
- Runtime: `libs/cell-runtime-ui/src/primitives/metric-card/MetricCard.types.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/metric-card/index.ts`.
- Runtime: `libs/cell-runtime-ui/src/primitives/metric-card/registerMetricCard.ts`.
