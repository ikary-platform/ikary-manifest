...
- `scopes` from the validated contract payload.
- `description` from the validated contract payload.
...
- Schema source: `libs/cell-contract-core/src/contract/manifest/role/RoleDefinitionSchema.ts`.
- Human contract doc: `RoleDefinitionSchema.md`.
- LLM contract doc: `RoleDefinitionSchema.llm.md`.
- Samples file: `RoleDefinitionSchema.samples.json` (minimum 5 valid examples).
