...
- Schema source: `libs/cell-contract-core/src/contract/manifest/page/PageTypeSchema.ts`.
- Human contract doc: `PageTypeSchema.md`.
- LLM contract doc: `PageTypeSchema.llm.md`.
- Samples file: `PageTypeSchema.samples.json` (minimum 5 valid examples).
