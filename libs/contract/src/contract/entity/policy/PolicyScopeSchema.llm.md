...
- Schema source: `libs/cell-contract-core/src/contract/entity/policy/PolicyScopeSchema.ts`.
- Human contract doc: `PolicyScopeSchema.md`.
- LLM contract doc: `PolicyScopeSchema.llm.md`.
- Samples file: `PolicyScopeSchema.samples.json` (minimum 5 valid examples).
